...
- telebot (pyTelegramBotAPI): библиотека для создания телеграмм-бота на pyt
...
1. Загрузите файл `prediction.json` содержащий данные о продуктах, с помощью компонента загрузки файлов в дашборде.
